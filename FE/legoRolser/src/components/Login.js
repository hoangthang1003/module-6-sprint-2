                            ...
                            <div className="wrapper bg-white mt-0">
                                ...
                                <div className="form-group py-2">
                                    ...
                                    <div className="input-field-1 mt-1">
                                        <Field type="text" className="input-login" placeholder="Nhập tài khoản"
                                               name="username"/>
                                    </div>
                                    <div>
                                ...
                                <div className="form-group py-1 pb-2">
                                    ...
                                    <div className="input-field-1 mt-1">
                                        <Field type={showPassword ? "text" : "password"} placeholder="Nhập mật khẩu"
                                               className="input-login" name="password"/>
                                        {
                                ...
                                <div className="d-flex justify-content-end">
                                    <a type="button" className="a-login" href="#" id="forgot"
                                       onClick={handleShowFromEmail}>Quên mật khẩu?</a>
                                </div>
                                ...
                                <div className="modal-dialog ">
                                    <div className="modal-content" style={{marginTop: 270}}>
                                        ...
                                        <div className="modal-body">
                                            ...
                                            <div>
                                                <label htmlFor="email" className="form-label fw-bold">Xác Nhận
                                                    Email:</label>
                                            </div>
                                            <div>
                            ...
                            <div className="modal-dialog">
                                <div className="modal-content" style={{
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div>
                                            <label htmlFor="code" className="form-label fw-bold">Xác Nhận Mã
                                                OTP:</label>
                                        </div>
                                        <div>
                        ...
                        >
                            <div className="modal-dialog">
                                <div className="modal-content" style={{
                                    ...
                                    <div className="modal-body">
                                        <div className="mt-2">
                                            <label htmlFor="newPassword" className="fw-bold form-label">Mật khẩu
                                                mới:</label>
                                        </div>
                                                   ...
                                                   name="newPassword" placeholder="Nhập mật khẩu mới"/>
                                            {
                                                showNewPassword
                                                    ...
                                                    <i type="button" onClick={() => {
                                                       ...
                                                       className={`bi bi-eye-slash me-2 position-absolute top-50 translate-middle-y end-0`}></i>
                                                    :
                                                    <i type="button" onClick={() => {
                                                        setShowNewPassword(!showNewPassword)
                                                    }}
                                                       className={`bi bi-eye me-2 position-absolute top-50 translate-middle-y end-0`}></i>
                                            }
                                        </div>
                                        <div>
                                        ...
                                        <div className="mt-2">
                                            <label htmlFor="confirmPassword" className="fw-bold form-label">Xác nhận mật
                                                khẩu:</label>
                                        </div>
                                        <div className="position-relative">
                                            <Field type={showConfirmPassword ? "text" : "password"}
                                                   id="confirmPassword" className="form-control" name="confirmPassword"
